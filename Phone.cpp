...
void Menu()
{
    ...
    {
        char in;
        cout << "1.Save New Contact " << endl << "2.Display All Saved Contact ";
        cout << endl << "3.Search Specific Contact ";
        cout << endl <<"4.Modify Existing Contact";
        cout << endl <<"5.Delete Specific Contact ";
        cout << endl <<"6.Delete All Existing Contacts ";
        cout << endl <<"7.Exit";
        cout << endl <<">> ";
        cin >> in;
        if (in == '1')
