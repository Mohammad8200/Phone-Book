...
void Menu()
{
    ...
    {
        char in;
        cout << "1.Save New Contact\033[0m" << endl;
        cout << "2.Display All Saved Contact\033[0m" << endl;
        cout << "3.Search Specific Contact\033[0m" << endl;
        cout << "4.Modify Existing Contact\033[0m" << endl;
        cout << "5.Delete Specific Contact\033[0m" << endl;
